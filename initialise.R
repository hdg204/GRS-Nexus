system('curl https://raw.githubusercontent.com/hdg204/GRS-Nexus/main/GRS_step_1.sh > GRS_step_1.sh')
system('curl https://raw.githubusercontent.com/hdg204/GRS-Nexus/main/GRS_step_2.sh > GRS_step_2.sh')
system('chmod +777 GRS_step_1.sh')
system('chmod +777 GRS_step_2.sh')
system('./GRS_step_1.sh')
system('curl https://raw.githubusercontent.com/hdg204/GRS-Nexus/main/Example_GRS > Example_GRS')
